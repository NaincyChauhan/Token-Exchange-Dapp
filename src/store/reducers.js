...
export const exchange = (state = { loaded: false, contract: {}, transaction: { isSuccessful: false }, events: [], allOrders: { loaded : false, data: []}, filledOrders: {loaded: false, data: []} }, action) => {
    let index, data;
    switch (action.type) {
